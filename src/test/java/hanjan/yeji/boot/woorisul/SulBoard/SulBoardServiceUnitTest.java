...
//
////    @Test
////    @DisplayName("SulBoardService read")
////    void getAllDrinkList(){
////
////
////        List<SulBoard> results = sbsrv.getAllDrinkList();
////        assertNotNull(results);
////    }
////
////    @Test
////    @DisplayName("SulBoardService select test")
////    void selectDrinkListByCategory(){
////
////        String kind = "증류주";
////
////        List<SulBoard> results = sbsrv.selectDrinkListByCategory(kind);
////        assertNotNull(results);
////
////    }
//
